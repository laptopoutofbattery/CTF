...
3. Calculate **phi** (totient) through **Φ(n)** [Euler's totient](https://brilliant.org/wiki/eulers-totient-function/) **λ(n)** [Carmichael function](https://en.wikipedia.org/wiki/Carmichael%27s_totient_function)
